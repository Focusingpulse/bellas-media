...
What went live on the blog, when. Newest first.

| Date | Title | URL | Status |
|------|-------|-----|--------|
| 2026-09-12 | Standard vs deep clean: why the best choice is a strategic cycle | `/standard-vs-deep-clean-why-the-best-choice-is-a-strategic-cycle/` | Live (post 5164) |

---

## Queue — drafted, awaiting sign-off

Six drafts are staged in the private vault under `pre-publish/drafts/`. None
publish until Sandra signs off (SO-04).

| Draft | Subject | Timing |
|-------|---------|--------|
